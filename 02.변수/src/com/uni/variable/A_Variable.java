package com.uni.variable; // A_Variable이 다른 패키지이기 때문에 같은 클래스명을 적어도 에러가 나지 않는다

public class A_Variable {
	// 변수란: 어떠한 값을 메모리에 기억하기 위한 공간이다 (박스 같은 개념)
	/* 변수를 사용하는 이유:
	 * 변수는 우선적으로 값에 의미를 부여하기 위한 목적으로 사용한다. (가독성이 좋아짐_
	 * 또한 한번값을 저장해 두고 계속 사용할 목적으로 사용된다.
	 * 
	 * --> 유지보수를 쉽게 하기 위한 목적
	 */
	...
	public void declareVariable() {
		...
		byte bNum; // 1byte
		short sNum; // 2byte
		int iNum; // 4byte --> 정수형 중에 가장 대표적인 자료형 (기본형 -21억 ~ 21억 xxxx 까지 값이 담기는 자료형)
		long lNum; // 8byte
		...
		/* 변수에 값 대입
		 * 위에서 값을 담기 위한 공간을 확보했다면 해당 변수에 값 대입 가능
		 * 
		 * [표현법] 변수명 = 값;
		 */
		...
		ch = '강';
		str = "ABC"; // 쌍따옴표를 이용해서 값 대입
		str = "A"; // 한 개의 문자만 써도 쌍따옴표 이용
	...
	public void initVariable() {
		...
		short sNum = 2;
		int iNum = 5;
		long lNum = 8L; // L을 붙여야 함
		
		float fNum = 4.0f; // 반드시 f를 붙여야 함
		...
		char ch2 = '강';
		String str = "ABC"; // 쌍따옴표를 이용해서 값 대입
		String str2 = "A"; // 한 개의 문자만 써도 쌍따옴표 이용
